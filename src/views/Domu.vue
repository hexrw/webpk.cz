...
<div class="bg-blue-500 text-white px-5 pt-0 md:pt-6 lg:pt-10">
    ...
    <router-link
        to="/cenik"
        class="w-fit bg-gray-800 text-lg shadow-lg text-white font-bold py-2 px-6 md:px-10 rounded-md mx-auto block mt-12 transition-all hover:scale-110"
...
<div class="p-5">
    ...
    <p class="text-xl pt-2"><router-link to="/kontakt" class="underline hover:no-underline text-blue-500">Kontaktujte mne</router-link></p>
</div>
