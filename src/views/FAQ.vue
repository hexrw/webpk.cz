...
<form class="mb-8">   
    ...
    <div class="relative">
        ...
        <input type="search" id="default-search" @input="e => searchInput = e.target.value" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Začněte psát pro vyhledávání v otázkách..." required>
    </div>
</form>
