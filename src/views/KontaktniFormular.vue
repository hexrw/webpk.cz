...
<h2 class="text-3xl -ml-6">Co bude následovat?</h2>
    
<ol class="relative border-l border-gray-200 pt-8">                  
    <li class="mb-10 ml-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white"></div>
        <span class="mb-1 font-normal leading-none text-gray-800">Odeslání kontaktního formuláře</span>
        <p class="mb-4 text-base font-normal text-gray-500">Odešlete mi vyplněný kontaktní formulář.</p>
    </li>
    <li class="mb-10 ml-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white"></div>
    ...
    <li class="mb-10 ml-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white"></div>
        <span class="mb-1 font-normal leading-none text-gray-800">Projektový formulář</span>
        <p class="mb-4 text-base font-normal text-gray-500">Odešlete mi vyplněný projektový formulář - ten se týká převážně struktury webových stránek, designu webových stránek a požadovaných funkcí.</p>
    </li>
    <li class="mb-10 ml-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white"></div>
